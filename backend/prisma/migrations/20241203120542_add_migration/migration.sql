/*
  ...
  - Made the column `ubicacion` on table `recurso` required. This step will fail if there are existing NULL values in that column.

*/
-- AlterTable
ALTER TABLE `recurso` MODIFY `fecha_ingreso` DATETIME NOT NULL,
    MODIFY `ubicacion` VARCHAR(500) NOT NULL;
