/*
  ...
  - You are about to alter the column `grado` on the `sanciones` table. The data in that column could be lost. The data in that column will be cast from `Int` to `Enum(EnumId(0))`.
...
-- AlterTable
ALTER TABLE `sanciones` MODIFY `grado` ENUM('GRAVE', 'LEVE') NOT NULL;
